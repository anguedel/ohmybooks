  ...
  <div class="relative py-5">
    ...
    <div class="container relative z-10">
      <div class="text-center mb-5">
        <h1 class="d-inline-block" style="background-color: #d38e0d; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;">
          Frases célebres
        </h1>
      </div>
          ...
          <div v-for="frase in frasesPorCategoria[categoriaSeleccionada]" :key="frase.texto"
            ...
            <div class="text-center">
              <form v-if="user" :action="route('frases.like', frase.id)" method="POST">
                ...
                <button type="submit"
                        :style="frase.yaDioLike
                                ? 'background-color: #d38e0d; color: white; border: 2px solid #d38e0d;'
                                : 'color: #d38e0d; border: 2px solid #d38e0d;'"
                        class="btn btn-sm mb-2 fw-semibold">
